...
namespace CSFramework {
	...
	public class SlotDebug {
        ...
        [Tooltip("Enables debug features such as diagnostics display and triggering game effects")]
        public bool useDebugKeys;
        [Tooltip("Enables keyboard input for changing bets, lines, and initiating spins")]
        public bool useKeyboardInput;
        [Tooltip("Only applies to running the game online from an web survey platform (e.g., Qualtrics). This specifies the only URL that can recieve data transfers. Leaving this blank is a security risk!")]
        public string dataDestinationURL = "https://thewebsurveyplatform";
