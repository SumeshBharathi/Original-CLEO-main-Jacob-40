...
namespace CSFramework {
	...
	public class BaseSlotGameUI : MonoBehaviour {
		...
		public Text textCredits, textDollars, textRoundCost, textRound, textScene, textIncome, textBet, textFreeSpin, textBonus, debugText;
		...
		public virtual void OnReelStart(ReelInfo info) {
            ...
            if (slot.currentMode != slot.modes.freeSpinMode) textIncome.text = "0"; 
			if (info.isFirstReel) {
				RefreshRoundInfo();
				RefreshMoney();
			}
		...
		*/
		...
		public virtual void RefreshMoney() {
            ...
            textDollars.text = "" + slot.gameInfo.dollars;
        }
		...
		public virtual void RefreshRoundInfo() {
            ...
            textScene.text = "" + slot.gameInfo.sceneVersion;
            RefreshFreeSpin();
			RefreshBonus();
		}
        ...
        public virtual void EnableLines() { }
    }
}