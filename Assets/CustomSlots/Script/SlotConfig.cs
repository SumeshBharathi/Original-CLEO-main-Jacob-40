...
namespace CSFramework {
	...
	public class SlotConfig {
		...
		public class ReelConfig {
			[Space, Tooltip("Represents the number of symbols each reel has"), Range(1, 10000)] public int symbolsPerReel = 999;
		...
		public class AdvancedConfig {
            ...
            [Tooltip("Use index positions rather than reel timings to choose symbols. This prevents variation in symbols sequences. This should be adjusted in tandem with reel timings or the three settings below, otherwise reels may spin for a long time.")] public bool stopReelsWithIndex = false;
            [Tooltip("When using an index positions to choose symbols, sets the offset of the first reel")] public int defaultSpinOffset = 12;
            [Tooltip("When using an index positions to choose symbols, sets the offset of subsequent reels")] public int reelOffset = 4;
            [Tooltip("When using an index positions to choose symbols, sets the additional offset of reels during free spins")] public int freeSpinSpinOffset = 4;
